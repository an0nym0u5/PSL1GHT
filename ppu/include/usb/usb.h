...
s32 usbInit(void);
s32 usbEnd(void);
s32 usbOpenPipe(s32 dev_id, usbEndpointDescriptor *end_desc);
s32 usbClosePipe(s32 pipe_id);
s32 usbAllocateMemory(void **ptr, size_t size);
s32 usbFreeMemory(void *ptr);
void *usbScanStaticDescriptor(s32 dev_id, void *ptr, unsigned char type);
s32 usbGetDeviceLocation(s32 dev_id, unsigned char *location);
s32 usbGetDeviceSpeed(s32 dev_id, u8 *speed);
void *usbGetPrivateData(s32 dev_id);
s32 usbSetPrivateData(s32 dev_id, void *priv);
s32 usbGetThreadPriority(s32 thread_type);
//s32 usbSetThreadPriority(UNKNOWN);
s32 usbSetThreadPriority2(s32 event_prio, s32 usb_prio, s32 callback_prio);
s32 usbRegisterLdd(usbLddOps *lddops);
s32 usbUnregisterLdd(usbLddOps *lddops);
s32 usbRegisterExtraLdd(usbLddOps *lddops, u16 id_vendor, u16 id_product);
s32 usbRegisterExtraLdd2(usbLddOps *lddops, u16 id_vendor, u16 id_product_min, u16 id_product_max);
s32 usbUnregisterExtraLdd(usbLddOps *lddops);
/*
s32 usbIsochronousTransfer(s32 pipe_id, usbIsochRequest *req, usbIsochDoneCallback done_cb, void *arg);
s32 usbHSIsochronousTransfer(s32 pipe_id, usbHSIsochRequest *req, usbHSIsochDoneCallback done_cb, void *arg);
s32 usbControlTransfer(s32 pipe_id, usbDeviceRequest *dr, void *buf, usbDoneCallback done_cb, void *arg);
s32 usbBulkTransfer(s32 pipe_id, void *buf, s32 len, usbDoneCallback done_cb, void* arg);
s32 usbInterruptTransfer(s32 pipe_id, void *buf, s32 len, usbDoneCallback done_cb, void *arg);
*/
